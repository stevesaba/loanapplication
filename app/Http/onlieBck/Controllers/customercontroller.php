...
class customercontroller extends Controller
{
    ...
    {
        return view('customerAppliedLoan',['CustomerName'=>Session::get('CustomerName'),'CustomerID'=>Session::get('CustomerID'),'CustomerEmail'=>Session::get('CustomerEmail'),'CustomerToken'=>Session::get('CustomerToken')]);
    }
