        ...
        <div class="container">
          ...
          <form action="{{ url('api/register')}}" method="post">
            ...
            <div class="form-group field">
              <input type="name" name="name" class="form-control email" placeholder="Customer Name" required>
            </div>
            <div class="form-group field">
              <input type="email" name="email" class="form-control email" placeholder="Email ID" required>
            </div>
            <div class="form-group field mb30">
              <input type="password" name="password" class="form-control pass" placeholder="Password" required>
            </div>
            <div class="form-group field mb30">
              <input type="password" name="confirm-password" class="form-control pass" placeholder="Confirm Password" required>
            </div>
            <div><input type="submit" name="submit" class="btn btn-info" value="Create Account"></div> 
           <div class="clearfix">
        Already have an account? <a href="{{ url('/customerlogin')}}">Login</a>
            </div>
          </form>
